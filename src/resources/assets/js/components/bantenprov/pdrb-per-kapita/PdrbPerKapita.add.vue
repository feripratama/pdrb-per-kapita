    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/pdrb-per-kapita/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/pdrb-per-kapita/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/pdrb-per-kapita/create'
                  }
                },
                window.location.href = '#/admin/pdrb-per-kapita/create')
        ...
        back() {
            window.location = '#/admin/pdrb-per-kapita';
        }
    },
    mounted: function() {
        axios.get("/pdrb-per-kapita/create").then(response => {
